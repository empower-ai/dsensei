...
export default function Sidebar({ elements }: Props) {
  return (
    <div
      id="docs-sidebar"
      className="fixed top-0 left-0 bottom-0 z-[60] w-72 bg-white border-r border-gray-200 shadow pt-7 pb-10 lg:block lg:translate-x-0 lg:right-auto lg:bottom-0 dark:scrollbar-y dark:bg-gray-800 dark:border-gray-700"
    >
      <div className="px-6">
